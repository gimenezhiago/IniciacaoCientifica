...
// Kernel CUDA simples — cada thread calcula um elemento de C
...
int main(int argc, char *argv[]) {
    ...
    // Define as dimensões dos blocos e da grade
    dim3 dimBlock(16, 16);
    dim3 dimGrid((N + dimBlock.x - 1) / dimBlock.x,
                 (N + dimBlock.y - 1) / dimBlock.y);

    // Execução do kernel e medição de tempo
    ...
    // Cópia do resultado para o host
